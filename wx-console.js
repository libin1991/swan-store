...
function t() {
    return function(e) {
        function t(n) {
            ...
            return e[n].call(l.exports, l, l.exports, t),
            l.loaded = !0,
            l.exports
        }
        var o = {};
    ...
    function(e, t, o) {
        ...
        k = function() {
            ...
            default;
                ...
                void 0 !== document ? "complete" == document.readyState ? o() : v.
            default.bind(window, "load", o) : !
                function() {
                    var e = void 0,
                    t = function t() {
            ...
            return r(e, [{
                ...
                default.one(".vc-switch", this.$dom),
                    ...
                    l = 1 * d.getStorage("switch_y"); (n || l) && (n + o.offsetWidth > document.documentElement.offsetWidth && (n = document.documentElement.offsetWidth - o.offsetWidth), l + o.offsetHeight > document.documentElement.offsetHeight && (l = document.documentElement.offsetHeight - o.offsetHeight), 0 > n && (n = 0), 0 > l && (l = 0), this.switchPos.x = n, this.switchPos.y = l, v.
                default.one(".vc-switch").style.right = n + "px", v.
                default.one(".vc-switch").style.bottom = l + "px"),
                    v.
                ...
                value: function() {
                    ...
                    function(t) {
                        if (i === !1 && t.timeStamp - o < e && null != r) {
                            ...
                            c.initMouseEvent("click", !0, !0, window, 1, a.screenX, a.screenY, a.clientX, a.clientY, !1, !1, !1, !1, 0, null),
            ...
            },
            {
                ...
                default.one(".vc-content", e.$dom),
                    n = !1;
                    v.
                default.bind(o, "touchstart",
                    function(e) {
                        var t = o.scrollTop,
                        l = o.scrollHeight,
                        i = t + o.offsetHeight;
                        0 === t ? (o.scrollTop = 1, 0 === o.scrollTop && (v.
                    default.hasClass(e.target, "vc-cmd-input") || (n = !0))) : i === l && (o.scrollTop = t - 1, o.scrollTop === t && (v.
                    default.hasClass(e.target, "vc-cmd-input") || (n = !0)))
                    }),
                    v.
                default.bind(o, "touchmove",
                    function(e) {
                        n && e.preventDefault()
                    }),
                    v.
                default.bind(o, "touchend",
                    function(e) {
                        n = !1
                    })
                }
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    default, {
                        ...
                        o && (d.isString(o) ? l.innerHTML += o: d.isFunction(o.appendTo) ? o.appendTo(l) : d.isElement(o) && l.insertAdjacentElement("beforeend", o)),
                        v.
                    default.one(".vc-content", t.$dom).insertAdjacentElement("beforeend", l)
                    }),
                    e.trigger("addTopBar",
                    function(o) {
                        if (o) for (var n = v.
                    default.one(".vc-topbar", t.$dom), l = function(t) {
                            var l = o[t],
                            i = v.
                        default.render(_.
                        default, {
                        ...
                        default.bind(i, "click",
                            ...
                            default.all(".vc-topbar-" + e.id), "vc-actived"), v.
                    ...
                    function(t) {
                        if (t) for (var o = v.
                    default.one(".vc-tool-last"), n = function(n) {
                            var l = t[n],
                            i = v.
                        default.render(x.
                        default, {
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    if (void 0 === t) return console.warn("Plugin " + e + " does not exist."),
                    !1;
                    ...
                    default.one("#__vc_tab_" + e);
                        ...
                        for (var n = v.
                    default.all(".vc-topbar-" + e, this.$dom), l = 0; l < n.length; l++) n[l].parentNode.removeChild(n[l]);
                        var i = v.
                    default.one("#__vc_log_" + e);
                        i && i.parentNode.removeChild(i);
                        for (var r = v.
                    default.all(".vc-tool-" + e, this.$dom), a = 0; a < r.length; a++) r[a].parentNode.removeChild(r[a])
                    }
            ...
            },
            {
                ...
                default.addClass(o, "vc-toggle"),
                    o.length > 0 ? v.
                default.addClass(v.
                default.one(".vc-content", this.$dom), "vc-has-topbar") : v.
                default.removeClass(v.
        ...
        function p(e) {
            ...
            function o(e) {
                if (d(e)) {
                    ...
                    v += "[",
                    f++;
                    for (var m = 0; m < e.length; m++) o(e[m], e),
                    m < e.length - 1 && (v += ", ");
                    f--,
                    v += "]",
                    p.pop()
    ...
    function(e, t) {
        ...
        function o(e, t, o) {
            ...
            for (e = e.replace(/(\{\{ ?switch(.+?)\}\})[\r\n\t ]+\{\{/g, "$1{{"), e = e.replace(/^\n/, "").replace(/\n/g, "\\\n"); r = n.exec(e);) a(e.slice(i, r.index), !1),
            a(r[1], !0),
            i = r.index + r[0].length;
            a(e.substr(i, e.length - i), !1),
            l += 'return arr.join("");',
            l = "with (this) {\n" + l + "\n}";
        ...
        VConsoleDefaultTab = function(_VConsoleLogTab) {
            ...
            },
            {
                ...
                value: function() {
                    ...
                    window.onerror = function(t, o, n, l, i) {
                        var r = t;
            ...
            },
            {
                ...
                value: function evalCommand(cmd) {
                    ...
                    try {
                        var result = eval(cmd),
                        $content = void 0;
                        tool.isArray(result) || tool.isObject(result) ? $content = this.getFoldedLine(result) : (tool.isNull(result) ? result = "null": tool.isUndefined(result) ? result = "undefined": tool.isFunction(result) ? result = "function()": tool.isString(result) && (result = '"' + result + '"'), $content = _query2.
                    default.render(_item_code2.
                    default, {
                            content: result,
                            type: "output"
    ...
    function(e, t, o) {
        ...
        x = function(e) {
            ...
            },
            {
                ...
                value: function(e) {
                    for (var t = this,
                    o = ["All", "Log", "Info", "Warn", "Error"], n = [], l = 0; l < o.length; l++) n.push({
                        name: o[l],
                        data: {
            ...
            },
            {
                ...
                default.bind(t, "click",
                    ...
                    default.one(".vc-log", e.$tabbox);
                        f.
                    default.removeClass(l, "vc-log-partly-log"),
                        f.
                    default.removeClass(l, "vc-log-partly-info"),
                        f.
                    default.removeClass(l, "vc-log-partly-warn"),
                        f.
                    default.removeClass(l, "vc-log-partly-error"),
                        "all" == n ? f.
                    default.removeClass(l, "vc-log-partly") : (f.
                    default.addClass(l, "vc-log-partly"), f.
                    default.addClass(l, "vc-log-partly-" + n))
                    });
                    var o = f.
                default.one(".vc-content");
                    f.
                default.bind(o, "scroll",
                    function(t) {
            ...
            },
            {
                ...
                default.removeClass(t, "vc-log-partly-error"),
                    "all" == e ? f.
                default.removeClass(t, "vc-log-partly") : (f.
                default.addClass(t, "vc-log-partly"), f.
            ...
            },
            {
                ...
                value: function() {
                    var e = this;
                    window.console ? (this.console.log = window.console.log, this.console.info = window.console.info, this.console.warn = window.console.warn, this.console.debug = window.console.debug, this.console.error = window.console.error) : window.console = {},
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    default.one(".vc-item-content", a), d = 0; d < t.length; d++) {
                            var v = void 0;
                            try {
                                if ("" === t[d]) continue;
                        ...
                        f.
                    default.one(".vc-log", this.$tabbox).insertAdjacentElement("beforeend", a),
            ...
            },
            {
                ...
                default.one(".vc-fold-outer", i), "click",
                    ...
                    default.removeClass(i, "vc-toggle"), f.
                    default.removeClass(f.
                    default.one(".vc-fold-inner", i), "vc-toggle"), f.
                    default.removeClass(f.
                    default.one(".vc-fold-outer", i), "vc-toggle")) : (f.
                    default.addClass(i, "vc-toggle"), f.
                    default.addClass(f.
                    default.one(".vc-fold-inner", i), "vc-toggle"), f.
                    default.addClass(f.
    ...
    function(e, t, o) {
        ...
        b = function(e) {
            function t() {
                ...
                n = Array(o), l = 0; o > l; l++) n[l] = arguments[l];
                var a = r(this, (e = Object.getPrototypeOf(t)).call.apply(e, [this].concat(n)));
                return a.tplTabbox = p.
            default,
                a.allowUnformattedLog = !1,
                a
            }
            return a(t, e),
            c(t, [{
            ...
            },
            {
                ...
                value: function() {
                    ...
                    t = "Unknown",
                    i ? t = "Android " + i[2] : l ? t = "iPhone, iOS " + l[2].replace(/_/g, ".") : n ? t = "iPad, iOS " + n[2].replace(/_/g, ".") : o && (t = "iPod, iOS " + o[2].replace(/_/g, "."));
                    var r = t,
                    a = e.match(/MicroMessenger\/([\d\.]+)/i);
                    t = "Unknown",
                    a && a[1] ? (t = a[1], r += ", WeChat " + t, console.info("[system]", "System:", r)) : console.info("[system]", "System:", r),
                    t = "Unknown",
                    t = "https:" == location.protocol ? "HTTPS": "http:" == location.protocol ? "HTTP": location.protocol.replace(":", ""),
                    r = t;
                    var c = e.toLowerCase().match(/ nettype\/([^ ]+)/g);
                    t = "Unknown",
                    c && c[0] ? (c = c[0].split("/"), t = c[1], r += ", " + t, console.info("[system]", "Network:", r)) : console.info("[system]", "Protocol:", r),
            ...
            },
            {
                ...
                default.one(".vc-log", this.$tabbox), "click", ".vc-group-preview",
                    function(e) {
                        ...
                        d.
                    default.hasClass(t, "vc-actived") ? d.
                    default.removeClass(t, "vc-actived") : d.
                    default.addClass(t, "vc-actived"),
                        e.preventDefault()
                    });
                    var t = d.
            ...
            },
            {
                ...
                value: function(e, t) {
                    ...
                    default, i),
                        ...
                        n.status >= 400 && d.
                    default.addClass(d.
                    default.one(".vc-group-preview", r), "vc-table-row-error"),
                        a ? a.parentNode.replaceChild(r, a) : d.
                    default.one(".vc-log", this.$tabbox).insertAdjacentElement("beforeend", r),
                        this.domList[e] = r;
                        var c = Object.keys(this.reqList).length;
                        c != o && this.renderHeader(),
                        this.isInBottom && this.scrollToBottom()
                    }
                }
            },
...
function() {
    ...
    wx && wx.version && console.info("[system]", "WeChatLib:", wx.version.version + " (" + wx.version.updateTime + ")");
    var e = new vConsole.VConsolePlugin("wechat", "WeChat");
    e.on("init",
    function() {}),
    e.on("renderTab",
    function(e) {
        var t = ['<div style="padding:6px 8px;border-bottom:1px solid #EEE">', '<a style="border:1px solid #D9D9D9; background:#efeff4; display:inline-block; padding:6px 8px; color:#000;" href="javascript:;" onclick="wx.clearStorage();">wx.clearStorage()</a>', "</div>"];
        e(t.join(""))
    }),
